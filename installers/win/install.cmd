...
wsl -d Ubuntu-20.04 --cd ~ rm -f ~/dev-env-installer.sh
...
wsl -d Ubuntu-20.04 --cd ~ cd ./devenv-cli && ./install.sh
wsl -d Ubuntu-20.04 --cd ~ sh -c "cd ~/devenv-cli && ./install.sh"
wsl -d Ubuntu-20.04 --cd ~ devenv config