...
wsl -d Ubuntu-20.04 --cd ~ "sudo curl --ssl --silent %repo%/installers/wsl/install.sh -o '/tmp/dev-env-installer.sh'"
wsl -d Ubuntu-20.04 --cd ~ "sudo ls -al /tmp"

wsl -d Ubuntu-20.04 --cd ~ "sudo chmod +x '/tmp/dev-env-installer.sh'"
